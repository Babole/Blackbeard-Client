...
const Scoreboard = () => {
    ...
    const winners = descending.map((player, index) => {
       return(
        <div className="scoreboard-text" style={{border: 'none', borderRadius: '15px', padding: '0rem 2rem', margin: '1rem 6rem'}}>
  ...
  return (
    <div>
        <h1 className="scoreboard-text" style={{textAlign: 'center'}}>Scoreboard</h1>
